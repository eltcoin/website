  ...
  initBackground() {
    ...
    layers.forEach(layer => {
        for (let i = 0; i < layer.count; i += 1) {
            const star = new Particle(this.randomRange(0, width), this.randomRange(0, height), 0, 0);
    ...
    const createShootingStar = () => {
        const shootingStar = new Particle(this.randomRange(width / 2, width), this.randomRange(0, height / 2), 0, 0);
        shootingStar.setSpeed(this.randomRange(shootingStarSpeed.min, shootingStarSpeed.max));
